 ...
 * @returns
 */
UserInfoDlg.onClickOrganization = function (e, treeId, treeNode) {
 ...
 * @returns
 */
UserInfoDlg.showOrganizationSelectTree = function () {
 ...
 * 隐藏部门选择的树
 */
UserInfoDlg.hideOrganizationSelectTree = function () {
...
UserInfoDlg.collectData = function () {
    this.set('id').set('account').set('sex').set('password').set('avatar')
        .set('email').set('name').set('birthday').set('rePassword').set('orgid').set('phone');
};
...
$(function () {
    ...
    ztree.bindOnClick(UserInfoDlg.onClickOrganization);
    ztree.init();
    instance = ztree;
