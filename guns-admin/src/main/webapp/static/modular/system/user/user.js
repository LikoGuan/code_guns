...
MgrUser.initColumn = function () {
    var columns = [
        ...
        {title: '组织', field: 'orgName', align: 'center', valign: 'middle', sortable: true},
...
MgrUser.onClickOrganization = function (e, treeId, treeNode) {
    MgrUser.orgid = treeNode.id;
    MgrUser.search();
};
...
$(function () {
    ...
    var ztree = new $ZTree("organizationTree", "/organization/tree");
    ztree.bindOnClick(MgrUser.onClickOrganization);
    ztree.init();
});
