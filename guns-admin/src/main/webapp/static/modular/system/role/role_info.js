 ...
 * @returns
 */
RolInfoDlg.onClickOrganization = function (e, treeId, treeNode) {
    $("#orgName").attr("value", RolInfoDlg.deptZtree.getSelectedVal());
    $("#orgid").attr("value", treeNode.id);
};
RolInfoDlg.onDblClickOrganization = function (e, treeId, treeNode) {
    $("#orgName").attr("value", RolInfoDlg.deptZtree.getSelectedVal());
    $("#orgid").attr("value", treeNode.id);
 ...
 * @returns
 */
RolInfoDlg.showOrganizationSelectTree = function () {
...
$(function () {
    ...
    var organizationTree = new $ZTree("organizationTree", "/organization/tree");
    organizationTree.bindOnClick(RolInfoDlg.onClickOrganization);
    organizationTree.bindOnDblClick(RolInfoDlg.onDblClickOrganization)
    organizationTree.init();
    RolInfoDlg.deptZtree = organizationTree;
